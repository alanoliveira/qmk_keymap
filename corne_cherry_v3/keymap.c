...
//    ┌──────┬────┬────┬────┬─────┬─────┐             ┌──────┬─────────┬──────┬──────┬─────┬──────┐
//    │ caps │ 1  │ 2  │ 3  │  4  │  5  │             │  6   │    7    │  8   │  9   │  0  │ f13  │
//    ├──────┼────┼────┼────┼─────┼─────┤             ├──────┼─────────┼──────┼──────┼─────┼──────┤
//    │ lctl │ f1 │ f2 │ f3 │ f4  │ f5  │             │ left │  down   │  up  │ rght │ ins │ f14  │
//    ├──────┼────┼────┼────┼─────┼─────┤             ├──────┼─────────┼──────┼──────┼─────┼──────┤
//    │ lsft │ f6 │ f7 │ f8 │ f9  │ f10 │             │ home │  pgdn   │ pgup │ end  │ del │ ralt │
//    └──────┴────┴────┴────┼─────┼─────┼─────┐   ┌───┼──────┼─────────┼──────┴──────┴─────┴──────┘
//                          │ f11 │     │ f12 │   │ _ │  =   │ MK_TMUX │
//                          └─────┴─────┴─────┘   └───┴──────┴─────────┘
[_LOWER] = LAYOUT_split_3x6_3(
  KC_CAPS , KC_1  , KC_2  , KC_3  , KC_4   , KC_5    ,                        KC_6    , KC_7    , KC_8    , KC_9     , KC_0   , KC_F13 ,
  KC_LCTL , KC_F1 , KC_F2 , KC_F3 , KC_F4  , KC_F5   ,                        KC_LEFT , KC_DOWN , KC_UP   , KC_RIGHT , KC_INS , KC_F14 ,
  KC_LSFT , KC_F6 , KC_F7 , KC_F8 , KC_F9  , KC_F10  ,                        KC_HOME , KC_PGDN , KC_PGUP , KC_END   , KC_DEL , KC_RALT,
...
[_RAISE] = LAYOUT_split_3x6_3(
  ...
  KC_LCTL , LSFT(KC_COMM) , LSFT(KC_DOT) , KC_GRV  , KC_QUOT       , LSFT(KC_SLSH) ,                        XXXXXXX , KC_MINS , KC_PIPE , KC_LCBR , KC_RCBR , _______,
  KC_LSFT , KC_LBRC       , KC_RBRC      , KC_TILD , LSFT(KC_QUOT) , LSFT(KC_SCLN) ,                        XXXXXXX , KC_PLUS , KC_BSLS , KC_LBRC , KC_RBRC , _______,
                                                     KC_INT2       , CW_TOGG       , KC_ENT ,     _______ , _______ , _______
),
...
//    ├─────┼─────────┼─────────┼─────────┼─────────┼─────────┤                         ├─────────┼─────────┼─────────┼─────────┼─────────┼─────┤
//    │     │  wh_d   │  ms_l   │  ms_d   │  ms_r   │  vold   │                         │ RGB_MOD │ RGB_HUD │ RGB_SAD │ RGB_VAD │         │     │
//    └─────┴─────────┴─────────┴─────────┼─────────┼─────────┼──────┐   ┌──────────────┼─────────┼─────────┼─────────┴─────────┴─────────┴─────┘
//                                        │  btn3   │         │ mute │   │ system_power │ QK_BOOT │ EE_CLR  │
//                                        └─────────┴─────────┴──────┘   └──────────────┴─────────┴─────────┘
[_MISC] = LAYOUT_split_3x6_3(
  ...
  _______ , KC_WH_D    , KC_MS_L    , KC_MS_D    , KC_MS_R    , KC_VOLD    ,                        RGB_MOD    , RGB_HUD    , RGB_SAD    , RGB_VAD    , _______    , _______,
                                                   KC_BTN3    , _______    , KC_MUTE ,     KC_PWR , QK_BOOT    , EE_CLR
),
